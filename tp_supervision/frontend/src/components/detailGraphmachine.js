...
//   const memoryUsage = variableData.map(data => ({ x: new Date(data.collected_at), y: data.memory_percentage }));
//   const swapUsage = variableData.map(data => ({ x: new Date(data.collected_at), y: data.swap_used }));
//   const diskUsage = variableData.map(data => ({ x: new Date(data.collected_at), y: data.disk_percentage }));
//   const netBytesSent = variableData.map(data => ({ x: new Date(data.collected_at), y: data.net_bytes_sent }));
//   const netBytesRecv = variableData.map(data => ({ x: new Date(data.collected_at), y: data.net_bytes_recv }));
//   const cpuTemperature = variableData.map(data => ({ x: new Date(data.collected_at), y: data.cpu_temperature }));

//   const cpuLoadPerCore = {};
//   variableData.forEach(data => {
//     data.cpu_load_per_core.forEach((load, index) => {
//       if (!cpuLoadPerCore[index]) {
//         cpuLoadPerCore[index] = [];
//       }
//       cpuLoadPerCore[index].push({ x: new Date(data.collected_at), y: load });
//     });
//   });

//   const cpuLoadSeries = Object.keys(cpuLoadPerCore).map(key => ({
//     name: `Core ${key}`,
//     data: cpuLoadPerCore[key]
//   }));

//   const averageCpuLoad = variableData.map(data => {
//     const totalLoad = data.cpu_load_per_core.reduce((sum, load) => sum + load, 0);
//     const avgLoad = totalLoad / data.cpu_load_per_core.length;
//     return { x: new Date(data.collected_at), y: avgLoad };
//   });
...
//     ...commonOptions,
//     series: [{ name: 'Swap Usage (%)', data: swapUsage }]
//   };

//   const diskChartOptions = {
//     ...commonOptions,
//     series: [{ name: 'Disk Usage (%)', data: diskUsage }]
//   };

//   const networkChartOptions = {
//     ...commonOptions,
//     series: [
//       { name: 'Bytes Sent', data: netBytesSent },
//       { name: 'Bytes Received', data: netBytesRecv }
//     ]
//   };
...
//     series: [
//       ...cpuLoadSeries,
//       { name: 'Average CPU Load', data: averageCpuLoad, type: 'line', color: '#FF0000' }
//     ]
//   };

//   const temperatureChartOptions = {
//     ...commonOptions,
//     series: [{ name: 'CPU Temperature', data: cpuTemperature }]
//   };
...
//             <div className="cards">
//               <div className="card">
//                 <ApexCharts options={memoryChartOptions} series={memoryChartOptions.series} type="line" height={350} />
//               </div>
//               <div className="card">
//                 <ApexCharts options={swapChartOptions} series={swapChartOptions.series} type="line" height={350} />
//               </div>
//               <div className="card">
//                 <ApexCharts options={diskChartOptions} series={diskChartOptions.series} type="line" height={350} />
//               </div>
//               <div className="card">
//                 <ApexCharts options={networkChartOptions} series={networkChartOptions.series} type="line" height={350} />
//               </div>
//               <div className="card">
//                 <ApexCharts options={cpuChartOptions} series={cpuChartOptions.series} type="line" height={350} />
//               </div>
//               <div className="card">
//                 <ApexCharts options={temperatureChartOptions} series={temperatureChartOptions.series} type="line" height={350} />
//               </div>
//             </div>
...
//                 <h2>Memory, Swap, and Disk Usage</h2>
